...
async def clone(event):
    ...
    if s == True:
        await event.reply(r)
        return
    edit = await event.reply('İşlemeye Çalışıyorum.')
    if 't.me/+' in link:
    ...
    if 't.me' in link:
        ...
        if 't.me/c/' in link:
             try:
                 ...
                 if not file:
                     await edit.edit("Mesaj Alınamadı!")
                     return
                 ...
                 if not name:
                     if not file.file.mime_type:
                         await edit.edit("Dosya İçin Ad Getirilemedi.")
                         return
                     else:
                 ...
                 await edit.edit("Yüklemeye Hazırlanıyor.")
                 ...
                 print(e)
                 if 'Peer'in str(e):
                     await edit.edit("Kanal Bulunamadı, Katıldınız mı?")
                     return
                 await edit.edit("Başarısız, Tekrar Deneyin!")
